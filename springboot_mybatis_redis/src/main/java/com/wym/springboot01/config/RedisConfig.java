...
public class RedisConfig {
	 ...
	 * 单机版配置
	 * 
	 * @Title: JedisConnectionFactory @param @param
	 *         jedisPoolConfig @param @return @return
	 *         JedisConnectionFactory @throws
	 */
	 ...
	 * 注入封装RedisTemplate
	 * 
	 * @Title: redisUtil @return RedisUtil @autor lpl @throws
	 */
	@Bean(name = "redisUtil")
