...
import com.wym.enums.ResultTypeEnum;
...
public class ResponseBuilder {
    ...
    public static <T> RestfulDataResponse<T> buildOkDataResponse(T data) {
        return new RestfulDataResponse<T>(ResultTypeEnum.SUCCESS.getCode(), ResultTypeEnum.SUCCESS.getMessage(), data);
    }
    ...
    public static <T> RestfulDataResponse<T> buildFailDataResponse(String message, T data) {
        return new RestfulDataResponse<T>(ResultTypeEnum.FAIL.getCode(), message, data);
    }
